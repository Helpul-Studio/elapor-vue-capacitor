                            ...
                            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                <div class="grid">
                                    <div class="flex rounded-md shadow-sm">
                                        <input type="hidden" name="company-website" id="company-website" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300 p-2" v-model="reporting.longitude" placeholder="longitude" disabled>
                                    </div>
                                </div>

                                <div class="grid">
                                    <div class="flex rounded-md shadow-sm">
                                        <input type="hidden" name="company-website" id="company-website" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300 p-2" v-model="reporting.latitude" placeholder="latitude" disabled>
                                    </div>
                                </div>
