    ...
    <div class="bg-white max-w-lg mx-auto">
        ...
        <main class=" mx-5 mt-10 grid mb-20 gap-y-4 z-10 py-2">
            ...
            <div class="flex justify-between">
                <p class="my-auto text-xl font-bold">Data Pekerjaan</p>
            </div>
            ...
            <div class="card border-l-4 border-red-500 card-sm bg-base-100 shadow-md" v-for="(jobtask) in jobtasks" :key="jobtask.job_task_id">
                ...
                <div class="card-body" v-if="jobtask.jobtask.job_task_status != 'Ditugaskan'">
                    ...
                    <div class="card-actions justify-end flex">
                        <button @click="jobtaskStore.getReport(jobtask.jobtask.job_task_id)" class="btn btn-sm border-2">Lihat Detail Laporan</button>
                    </div>
                </div>
            </div>
        </main>
